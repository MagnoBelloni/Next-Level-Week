...
const Points = () => {
    ...
    function handleNavigateToDetail(id: Number = 0) {
                                ...
                                {points.map(point => (
                                    <Marker
                                        ...
                                        coordinate={{
                                            ...
                                            longitude: point.longuitude,
                                        }}
                                    >
                                        <View style={styles.mapMarkerContainer}>
                                            <Image style={styles.mapMarkerImage} source={{ uri: point.image_url_android }} />
                                            <Text style={styles.mapMarkerTitle}>
                                                {point.name}
                                            </Text>
                                        </View>
                ...
                >
                    ...
                    {items.map(item => (
                        <TouchableOpacity
                            ...
                            activeOpacity={0.6}
                        >
                            <SvgUri width={42} height={42} uri={item.image_url_android} />
